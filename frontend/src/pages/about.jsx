...
const About = () => {
    ...
    return (
        <div style={containerStyle}>
            ...
            <h3 style={{ fontSize: '1.5rem', color: '#f97316', marginBottom: '15px' }}>Debojyoti Roy</h3>

            <p style={{ color: '#a1a1aa', fontSize: '1.2rem', lineHeight: '1.8', maxWidth: '600px', margin: '0 auto 30px auto' }}>
                <strong>Welcome to the Website!</strong> Feel free to suggest any improvements.
            </p>

            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
                <a
                    href="https://instagram.com/debojyoti_ro"
                    target="_blank"
                    rel="noreferrer"
                    style={{
                        ...socialBtnStyle,
                    ...
                    <a
                    href="https://www.linkedin.com/in/debojyoti-roy-"
                    target="_blank"
                    rel="noreferrer"
                    style={{
                        ...socialBtnStyle,
                    ...
                    <a
                    href="https://github.com/Debocoderoid"
                    target="_blank"
                    rel="noreferrer"
                    style={{
                        ...socialBtnStyle,
