...
const Checkout = () => {
  ...
  const handlePayment = async () => {
    try {
      const useBypass = window.confirm(
          "Student Bypass Mode?\nPress OK to skip Razorpay.\nPress Cancel to pay with Razorpay."
      );
    ...
    <div className="checkout-container">
      ...
      <div className="checkout-content">
        <form onSubmit={handleSubmit} className="shipping-form">
          ...
          <input type="text" placeholder="Address" required value={address.address} onChange={(e) => setAddress({...address, address: e.target.value})} />
